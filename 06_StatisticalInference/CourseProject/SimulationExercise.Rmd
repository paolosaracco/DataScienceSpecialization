...
```{r plotExpshow, echo = F, ref.label = "plotExp", fig.show = "as.is", fig.cap = "Empirical Density", fig.align = "center"}
```
...
```{r compPlotshow, echo = F, ref.label = "compPlot", fig.show = "as.is", fig.cap = "Density Comparison", fig.align = "center"}
```
...
```{r qqshow, echo = F, ref.label = "qqplot", fig.show = "as.is", fig.cap = "q-q plot", fig.align = "center"}
```
