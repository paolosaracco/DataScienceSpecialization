...
```{r confInt, echo = F}
grp1mn <- t.test(grp1, alternative = "two.sided", conf.level = 0.99)$conf.int[1:2]
grp2mn <- t.test(grp2, alternative = "two.sided", conf.level = 0.99)$conf.int[1:2]
grp3mn <- t.test(grp3, alternative = "two.sided", conf.level = 0.99)$conf.int[1:2]
