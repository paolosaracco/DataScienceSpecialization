...
```{r downloadData, echo = F, cache = T, results='hide'}
...
training data set and a `r paste(dim(raw_testing)[1], "x", dim(raw_testing)[2], sep = " ")` test data set. Let us inspect the training data and leave aside the test data set.
...
| :---: | :---: | :---: | :---: | :---: |
| Decision Tree | `r round(ISaccTree,4)` | `r round(1-ISaccTree,4)` | `r round(OoSaccTree,4)` | `r round(1-OoSaccTree,4)` |
| Random Forest | `r round(ISaccRF,4)` | `r round(1-ISaccRF,4)` | `r round(OoSaccRF,4)` | `r round(1-OoSaccRF,4)` |
| Gradient-boosted Trees | `r round(ISaccGBM,4)` | `r round(1-ISaccGBM,4)` | `r round(OoSaccGBM,4)` | `r round(1-OoSaccGBM,4)` |
